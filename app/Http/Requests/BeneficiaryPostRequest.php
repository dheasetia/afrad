...
class BeneficiaryPostRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            'name'              => 'required|min:6',
            'national_number'   => 'required|digits:10|unique:beneficiaries',
            ...
            'iban'              => ['nullable', 'unique:beneficiaries', 'regex:/^SA\d{22}$/'],
        ];
    }
}
