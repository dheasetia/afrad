var ResearchCreate = function () {
    ...
    var updateNeed = function () {
        ...
        $('#total_item_need').text(totalItemNeeds);

        totalNeeds = totalMoneyNeeds + totalItemNeeds;

        $('#total_all_need').text(totalNeeds);
    ...
    var handleSave = function () {
        ...
        btnSave.click(function () {
            ...
            if (form.valid() && checkRequiredInputs()) {
                 ...
                 researchInputs.research_id = $('#research_id').val();
                 ...
                 researchInputs.project_manager_id = $('#project_manager_id').val();
                 researchInputs.general_manager_id = $('#general_manager_id').val();
    ...
    var handleValidation = function() {
        ...
        form.validate({
            ...
            messages: {
                ...
                project_manager_id: {
                    required: 'اسم مدير المشاريع إلزامي'
                },
                general_manager_id: {
                    required: 'اسم الأمين العام إلزامي'
                },
                beneficiary_id: {
