...
@section('content')
                ...
                <div class="modal-body">
                    <form id="form_add_role" autocomplete="off">
                        <div class="form-group">
                            <label for="role_add_input" class="control-label">اسم العلاقة أسرية</label>
                            <input type="text" class="form-control" name="role" id="role_add_input" autocomplete="off" autofocus>
                        </div>
                    </form>
                </div>
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="fa fa-share-alt"></i> العلاقات الأسرية</h4>
        </div>
    </div>
    ...
    <div class="row" id="panel_role">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">قائمة العلاقات الأسرية</h3>
                <div class="box-actions">
                    <button type="button" class="btn btn-sm btn-info" data-toggle="tooltip" title="إضافة علاقة أسرية" id="btn_add_role"><i class="fa fa-plus"></i> إضافة </button>
                </div>
...
@section('plugin_scripts')
    ...
    <script src="{{asset('js/pages/family_role_index.js')}}"></script>
@endsection