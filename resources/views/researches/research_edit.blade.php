...
@section('content')
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="fa fa-search"></i> دراسة حالة <span class="small">تعديل معلومات</span></h4>
        </div>
    </div>
    ...
    <form action="" method="post" accept-charset="utf-8" id="form_research_create">
                ...
                <div class="panel panel-info">
                    <div class="panel-wrapper collapse in" aria-expanded="true">
                        <div class="panel-body">
                            <div class="form-body">
                                <h3 class="box-title">معلومات البحث</h3>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="research_kind_id" name="research_kind_id" class="form-control">
                                                ...
                                                @foreach($research_kinds as $kind)
                                                    <option value="{{$kind->id}}" {{$research->research_kind_id == $kind->id ? 'selected' : ''}}>{{$kind->kind}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="hijri_research_date" name="hijri_research_date" value="{{$research->formatted_research_hijri_date}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="place" name="place" value="{{$research->place}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="researcher_name" name="researcher_name" value="{{$research->researcher->name}}" readonly>
                                            <input type="hidden" name="researcher_id" id="researcher_id" value="{{$research->researcher->id}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group {{$errors->has('beneficiary_id') ? ' has-error' : ''}}">
                                            <label class="control-label" for="beneficiary_id">اسم المستفيد <span class="required">*</span> </label>
                                            <select id="beneficiary_id" class="form-control" name="beneficiary_id">
                                                <option value="" selected>--- اختر ---</option>
                                                @foreach($beneficiaries as $beneficiary)
                                                    <option {{old('beneficiary_id') == '1' ? 'selected' : ''}} value="{{$beneficiary->id}}" {{$research->beneficiary->id == $beneficiary->id ? 'selected' : ''}}>{{$beneficiary->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-1">
                                        <a href="{{url('beneficiaries/create')}}" class="btn btn-info btn-add" data-toggle="tooltip" title="إضافة"><i class="fa fa-plus text-white"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-md-3 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <span class="form-control" id="national_number">{{$research->beneficiary->national_number}}</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-3 col-lg-2">
                                        <div class="form-group">
                                            <label class="control-label">الجنسية</label>
                                            <span class="form-control" id="nationality">{{$research->beneficiary->nationality != '' ? $research->beneficiary->nationality->nationality : ''}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 col-md-3 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <span class="form-control" id="marital_status">{{$research->beneficiary->marital_status != '' ? $research->beneficiary->marital_status->status : ''}}</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-3 col-lg-2">
                                        <div class="form-group">
                                            <label class="control-label">عدد أفراد الأسرة</label>
                                            <span class="form-control" id="family_member_count">{{$research->beneficiary->family_member_count}}</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-3 col-lg-2">
                                        <div class="form-group">
                                            <label class="control-label">عدد البنين</label>
                                            <span class="form-control" id="son_count">{{$research->beneficiary->son_count}}</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-3 col-lg-2">
                                        <div class="form-group">
                                            <label class="control-label">عدد البنات</label>
                                            <span class="form-control" id="daughter_count">{{$research->beneficiary->daughter_count}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel-wraper collapse in" aria-expanded="true">
                        <div class="panel-body">
                            <div class="form-body">
                                ...
                                <hr>
                                <div class="row" id="income_list">
                                    @foreach($research_incomes as $research_income)
                                        <div class="col-md-6 income_input_group" style="display: block;">
                                            <div class="col-xs-9 ">
                                                <div class="form-group">
                                                    <label for="income_amount_{{$loop->iteration}}" class="control-label">{{$research_income->income->income}}</label>
                                                    <input name="income_amount_{{$research_income->income->id}}" id="income_amount_{{$loop->iteration}}" class="form-control income_input" type="text" value="{{$research_income->amount}}">
                                                </div>
                                            </div>
                                            <div class="col-xs-3 delete-group">
                                                <button type="button" class="btn btn-danger waves-effect waves-light btn-delete btn_delete_income" tabindex="-1"><i class="fa fa-trash"></i></button>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="sub-total bg-primary">
                                            <p>إجمالي الدخل</p>
                                            <h2 id="total_income">{{$research->total_income}}</h2>
                        ...
                        <div class="panel-body">
                            <div class="form-body">
                                ...
                                <div class="row" id="expense_list">
                                    @foreach($research_expenses as $research_expense)
                                        <div class="col-md-6 expense_input_group" style="display: block;">
                                            <div class="col-xs-9 ">
                                                <div class="form-group">
                                                    <label for="expense_amount_{{$loop->iteration}}" class="control-label">{{$research_expense->expense->expense}}</label>
                                                    <input name="expense_amount_{{$research_expense->expense->id}}" id="expense_amount_{{$loop->iteration}}" class="form-control expense_input" type="text" value="{{$research_expense->amount}}">
                                                </div>
                                            </div>
                                            <div class="col-xs-3 delete-group">
                                                <button type="button" class="btn btn-danger waves-effect waves-light btn-delete btn_delete_expense" tabindex="-1"><i class="fa fa-trash"></i></button>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="sub-total bg-primary">
                                            <p>إجمالي المصروف</p>
                                            <h2 id="total_expense">{{$research->total_expense}}</h2>
                                            <p style="font-family: DroidNaskh, sans-serif">ريال سعودي</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 m-b-10">
                                        <div class="sub-total bg-info">
                                            <p>الفرق</p>
                                            <h1 id="total_diff">{{$research->difference}}</h1>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="sub-total bg-info">
                                            <p>النسبة المئوية</p>
                                            <h1 id="total_percentage">{{$research->percentage}}%</h1>
                                        </div>
                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="form-body">
                                ...
                                <div class="row" id="money_need_list">
                                    @foreach($research_money_needs as $money_need)
                                    <div class="money_need_input_group" style="display: block;">
                                        <div class="col-xs-9">
                                            <div class="form-group">
                                                <label for="money_need_amount_{{$loop->iteration}}" class="control-label">{{$money_need->money_need->description}}</label>
                                                <input name="money_need_amount_{{$money_need->money_need->id}}" id="money_need_amount_{{$loop->iteration}}" class="form-control money_need_input" type="text" value="{{$money_need->amount}}">
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <button type="button" class="btn btn-danger waves-effect waves-light btn-delete btn_delete_money_need" tabindex="-1"><i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="total-need-wrapper">
                                    <div class="total-money-need">
                                        ...
                                        <div class="total-need" id="total_money_need">{{$research->total_money_need}}</div>
                        ...
                        <div class="panel-body">
                            <div class="form-body">
                                ...
                                <div class="row" id="item_need_list">
                                    @foreach($research_item_needs as $item_need)
                                        <div class="col-md-3 item_form_group" style="display: block;">
                                            <button type="button" class="btn_delete_item_need" id="btn_delete_item_need_{{$item_need->item_need->id}}"><i class="fa fa-times-circle-o "></i></button>
                                            <h3 class="text-center text-white">{{$item_need->item_need->item}}</h3>
                                            <div class="form-group">
                                                <label for="item_need_price_{{$item_need->item_need->id}}" class="control-label">السعر</label>
                                                <input name="item_need_price_{{$item_need->item_need->id}}" id="item_need_price_{{$item_need->item_need->id}}" class="form-control item_need_price" type="text" value="{{$item_need->price}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="item_need_quantity_{{$item_need->item_need->id}}" class="control-label">الكمية</label>
                                                <input name="item_need_quantity_{{$item_need->item_need->id}}" id="item_need_quantity_{{$item_need->item_need->id}}" class="form-control item_need_quantity" type="text" value="{{$item_need->quantity}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="item_need_sub_total_{{$item_need->item_need->id}}" class="control-label">الإجمالي</label>
                                                <input name="item_need_sub_total_{{$item_need->item_need->id}}" id="item_need_sub_total_{{$item_need->item_need->id}}" class="form-control item_need_sub_total" readonly="" tabindex="-1" type="text" value="{{$item_need->subtotal}}">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="total-need-wrapper">
                                    <div class="total-money-need">
                                        ...
                                        <div class="total-need" id="total_item_need">{{$research->total_item_need}}</div>
                                        <div class="text-center">ريال سعودي</div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="well">
            <div class="total-all-wrapper">
                ...
                <div class="total-all" id="total_all_need">{{$research->total_need}}</div>
                <div class="text-center">ريال سعودي</div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" name="researcher_recommendation" id="researcher_recommendation">{{$research->researcher_recommendation}}</textarea>
                    </div>
                </div>
            </div>
        </div>
...
@section('plugin_scripts')
    ...
    <script src="{{asset('js/pages/research_edit.js')}}"></script>
@endsection