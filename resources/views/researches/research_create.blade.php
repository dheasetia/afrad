                            ...
                            <div class="row">
                                <div class="col-sm-4 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <span class="form-control" id="national_number"></span>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        <label class="control-label">الجنسية</label>
                                        <span class="form-control" id="nationality"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <span class="form-control" id="marital_status"></span>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        <label class="control-label">عدد أفراد الأسرة</label>
                                        <span class="form-control" id="family_member_count"></span>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        <label class="control-label">عدد البنين</label>
                                        <span class="form-control" id="son_count"></span>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        <label class="control-label">عدد البنات</label>
                                        <span class="form-control" id="daughter_count"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('plugin_scripts')
    ...
    <script src="{{asset('js/pages/research_create.js')}}"></script>
@endsection