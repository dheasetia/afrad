...
@section('content')
                ...
                <div class="modal-body">
                    <form id="form_add_expense" autocomplete="off">
                        <div class="form-group">
                            <label for="expense_add_input" class="control-label">اسم نوع المصروف</label>
    ...
    <div class="row" id="panel_expense">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">قائمة أنواع المصروفات</h3>
                <div class="box-actions">
                    <button type="button" class="btn btn-sm btn-info" data-toggle="tooltip" title="إضافة نوع مصروف" id="btn_add_expense"><i class="fa fa-plus"></i> إضافة </button>
                </div>
                <div class="table-responsive">
                    <table class="table" id="table_expenses">
                        <thead>
                        <tr>
...
@section('plugin_scripts')
    ...
    <script src="{{asset('js/pages/expense_index.js')}}"></script>
@endsection