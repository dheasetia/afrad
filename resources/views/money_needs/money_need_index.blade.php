...
@section('content')
                ...
                <div class="modal-body">
                    <form id="form_add_need" autocomplete="off">
                        <div class="form-group">
                            <label for="need_add_input" class="control-label"> بيان الاحتياج المالي</label>
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="fa fa-address-card-o"></i> الاحتياجات المالية </h4>
        </div>
    </div>
    ...
    <div class="row" id="panel_need">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">قائمة الاحتياجات المالية</h3>
                <div class="box-actions">
                    <button type="button" class="btn btn-sm btn-info" data-toggle="tooltip" title="إضافة احتياج مالي" id="btn_add_need"><i class="fa fa-plus"></i> إضافة </button>
                </div>
...
@section('plugin_scripts')
    ...
    <script src="{{asset('js/pages/money_need_index.js')}}"></script>
@endsection