            ...
            <div class="panel panel-info">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form action="{{url('users', $user->id)}}" method="post" id="form_user_create" accept-charset="utf-8">
                            {{csrf_field()}}
                            {{method_field('put')}}
                            ...
                            <div class="form-body">
                                ...
                                <div class="box-actions">
                                    <a href="{{url('users', $user->id) . '/delete_confirmation?prev_page=user_show'}}"  class="btn btn-sm btn-danger" data-toggle="tooltip" title="حذف هذا المستخدم"><i class="fa fa-trash"></i> </a>
                                        ...
                                        <div class="form-group {{$errors->has('role_id') ? ' has-error' : ''}}">
                                            ...
                                            <select id="role_id" class="form-control" name="role_id">
                                                ...
                                                @foreach($roles as $role)
                                                    <option {{old('role_id', $user->first_role_id) == $role->id ? 'selected' : ''}} value="{{$role->id}}" >{{$role->label}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
