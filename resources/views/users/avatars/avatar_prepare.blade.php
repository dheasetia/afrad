        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <form action="{{url('users', $user->id) . '/avatars'}}" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="form_user_create">
                        {{csrf_field()}}
                        <div class="panel-body">
                            <div class="form-body">
                                <h3 class="box-title">إضافة صورة المستخدم: {{$user->name}}</h3>
                                <hr>
                                <div class="row">
